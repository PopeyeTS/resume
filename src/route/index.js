    ...
    page: [
      {
        name: '"Summary"',
        link: '/summary',
        title: 'Практика HTML.Резюме. 1 частина',
        description:
          'Завдання No1. Завдання No2. Завдання No3.',
      },
      {
        name: '"skills"',
        link: '/skills',
        title: 'Практика HTML.Резюме. 2 частина',
        description:
          'Завдання No1. Завдання No2. Завдання No3.',
      },
      {
        name: '"education"',
        link: '/edu',
        title: 'Практика HTML.Резюме. 3 частина',
        description:
          'Завдання No1. Завдання No2. Завдання No3.Завдання No4.Завдання No5.',
      },
      {
        name: '"work"',
        link: '/work',
        title: 'Практика HTML.Резюме. 4 частина',
        description:
          'Завдання No1. Завдання No2. Завдання No3.Завдання No4.Завдання No5.',
      },
      {
        name: '"person"',
        link: '/person',
        title: 'Практика HTML.Резюме. 5 частина',
        description: 'Завдання No1.',
      },
      {
        name: '"bio"',
        link: '/bio',
        title: 'Практика HTML.Резюме. 4 частина',
        description: 'Завдання No2.',
      },
      {
        name: '"program"',
        link: '/program',
        title: 'Практика HTML.Резюме. 6 частина',
        description: 'Завдання No1.',
      },
      {
        name: '"Web"',
      ...
      },
      {
        ...
        link: '/js',
        title: 'Знайомство з Bootstrap',
        description: 'Завдання No3.',
      },
      {
        name: '"facebook"',
        link: '/facebook',
        title: 'Знайомство з Bootstrap',
        description: 'Завдання No4.',
      },
      {
        name: '"task21"',
        link: '/task21',
        title: 'Bootstrap: Текст, кнопки та блоки',
        description: 'Завдання No2.1',
      },
      {
        name: '"task22"',
        link: '/task22',
        title: 'Bootstrap: Текст, кнопки та блоки',
        description: 'Завдання No2.2',
      },
      {
        name: '"task31"',
        link: '/task31',
        title: 'Bootstrap: Текст, кнопки та блоки',
        description: 'Завдання No3.1',
      },
      {
        name: '"shophome"',
        link: '/shophome',
        title:
          'Bootstrap: Навігація, значки та повідомлення',
        description: 'Завдання No4.1',
      },
      {
        name: '"shopproduct"',
        link: '/shopproduct',
        title: 'Bootstrap: Порядковий номер',
        description: 'Завдання No4.2',
      },
      {
        name: '"shopnews"',
        link: '/shopnews',
        title: 'Bootstrap: Порядковий номер',
        description: 'Завдання No4.3',
      },
      {
        name: '"shoporder"',
        link: '/shoporder',
        title: 'Bootstrap: Компоненти форми',
        description: 'Завдання No5.1',
      },
      {
        name: '"shopcart"',
        link: '/shopcart',
        title: 'Bootstrap: Іконки',
        description: 'Завдання No6.1',
      },
      {
        name: '"shopprofile"',
        link: '/shopprofile',
        title: 'Bootstrap: Іконки',
        description: 'Завдання No6.2',
      },
      {
        name: '"shopreview"',
        link: '/shopreview',
        title: 'Знайомство з СSS',
        description: 'Завдання No7.1',
      },
      {
        name: '"shopcatalog"',
        link: '/shopcatalog',
        title: 'Знайомство з СSS',
        description: 'Завдання No7.2',
      },
    ],
  })
